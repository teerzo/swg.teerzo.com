...
export default function EntBuff() {
    ...
    const defaultOptions = [
        ...
        { id: 'chance', name: 'Second Chance', group: 'misc', description: 'blah', points: 2, max: 10, per: 2, stats: 3, statsText: '% chance to automatically heal when struck in combat', checked: false },
    ...
    return (
        ...
        <div className="flex flex-col w-full items-center">
            <div className="flex flex-row flex-grow w-full justify-center gap-1 mb-2">
                <div className="flex flex-row bg-sky-300 rounded-lg border border-sky-300 p-2">
            ...
            <div className="flex flex-col md:flex-row flex-grow w-full  justify-center gap-2 mb-2">
                <div className="flex flex-col w-full gap-1">

                    <div className='flex flex-col md:flex-row w-full gap-1'>

                        <div className="border-base-200 border-2 rounded w-full">
                ...
                <div className="flex flex-col w-full md:w-1/2 gap-1">
                    ...
                    <div className='flex-grow border-base-200 border-2 p-2'>
                        ...
                        <div className="flex flex-row w-full">
                            <input className="w-full input border p-2" placeholder="Search" value={message} onChange={() => { }} />
                            <div className="indicator">
                                <button className="border p-2" onClick={() => { navigator.clipboard.writeText(message) }}> Copy </button>
                            </div>
                        </div>
                    </div>
                </div>
